...
//     if (args.collectionName === 'Categories') {
//         readCategories(resolve, reject);
//     } else if (args.collectionName === 'UpcomingClasses') {
...
//     function allocate(args, resolve, reject) {

//        var newUpcomingClass = Models.UpcomingClass(args.newClassInfo);
...
//     self.create = PROMISIFY(function (args, resolve, reject) {
        
//         var model = new Models.UpcomingClass(_.extend({}, args));
...
//     self.retrieveAll = PROMISIFY(function (args, resolve, reject) {
